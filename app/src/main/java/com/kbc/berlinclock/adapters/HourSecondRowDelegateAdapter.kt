...
import com.kbc.berlinclock.HourSecondRow
...
class HourSecondRowDelegateAdapterIDelegateAdapter: IDelegateAdapter {
    ...
    class HourSecondRowViewHolder(private val view: ItemBlocksBinding,
                                 private val delegateAdapter: HourSecondRowDelegateAdapterIDelegateAdapter): RecyclerView.ViewHolder(view.root) {
